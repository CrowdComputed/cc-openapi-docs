...
import {
  defaultAdapters,
  type MediaAdapter,
} from "@/openapi/requests/media/adapter";
import type { OpenAPIServer } from "@/openapi/server";
import type { MethodInformation, RenderContext } from "@/openapi/types";
import { Operation } from "@/openapi/ui/operation";
import type { ProcessedDocument } from "@/openapi/utils/process-document";
import { createMethod, type NoReference } from "@/openapi/utils/schema";
