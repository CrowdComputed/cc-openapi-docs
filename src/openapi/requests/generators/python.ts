"use client";
import { resolveMediaAdapter } from "@/openapi/requests/media/adapter";
import { generatePythonObject } from "@/openapi/requests/to-python-object";
import type { SampleGenerator } from "@/openapi/requests/types";
