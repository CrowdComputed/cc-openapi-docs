...
import { Input, labelVariants } from "@/openapi/ui/components/input";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/openapi/ui/components/select";
import { cn } from "@/openapi/utils/cn";
import type { ParsedSchema } from "@/openapi/utils/schema";
import { FormatFlags, schemaToString } from "@/openapi/utils/schema-to-string";
        ...
        toolbar={
          <>
            {showSelect && (
              ...
              >
                {union.map((item: ParsedSchema, i: number) => (
                  <option
                    key={i.toString()}
                    value={i}
